...
// After scraping, prepare the data for storage
$data = [
    'passstatus' => $gotthard_data['gotthard_pass_status'],
    'stau_nord' => $gotthard_data['nord_km'],
    'stau_sued' => $gotthard_data['sued_km'],
    //'zeitverlust_nord' => null, // You'll need to add this data to your scraping
    //'zeitverlust_sued' => null, // You'll need to add this data to your scraping
];

// Call load.php to store the data
